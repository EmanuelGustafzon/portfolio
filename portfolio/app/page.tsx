    ...
    <div>
      ...
      <div className='flex justify-center mt-3 mb-3 w-76 lg:ml-32 lg:mr-32 mt-8 mb-8 bg-color-red'>
        <p>
          ...
          I'm dedicated, flexible, and passionate about coding. I thrive on new challenges and am always eager to learn. Friendly by nature, I'm excited to contribute my skills to exciting projects.
